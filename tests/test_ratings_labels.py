...
def test_default_within_12m_flagged():
    events = _crosswalked_events("0000000002", "FTC", [
        ("2019-02-01", 14, STATUS_RATED),    # B
        ("2020-05-01", 17, STATUS_RATED),    # CCC (downgrade)
    ...
    assert r["rating_index_12m"] == 21       # D by 2021-12-31
    assert r["label_12m"] == 1               # downgrade
    assert r["default_12m"] is True          # default event 2021-03-01 within (2020-12-31, 2021-12-31]
